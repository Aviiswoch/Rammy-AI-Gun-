...
enum uvc_preview_performance_stat_index {
    UVC_PREVIEW_RAW_FRAMES_RECEIVED = 0,
    UVC_PREVIEW_RAW_FRAMES_ACCEPTED,
    UVC_PREVIEW_RAW_FRAMES_DROPPED_VALIDATION,
    UVC_PREVIEW_STALE_FRAMES_DROPPED,
    UVC_PREVIEW_FRAMES_DECODED,
    UVC_PREVIEW_FRAMES_PUBLISHED,
    UVC_PREVIEW_CONVERSION_TOTAL_NS,
    UVC_PREVIEW_CONVERSION_MAX_NS,
    UVC_PREVIEW_RAW_MAX_GAP_NS,
    UVC_PREVIEW_DECODED_MAX_GAP_NS,
    UVC_PREVIEW_QUEUE_DEPTH,
    UVC_PREVIEW_QUEUE_MAX_DEPTH,
    UVC_PREVIEW_POOL_AVAILABLE,
    UVC_PREVIEW_CALLBACK_FRAMES,
    UVC_PREVIEW_LAST_RAW_NS,
    UVC_PREVIEW_LAST_ACCEPTED_NS,
    UVC_PREVIEW_LAST_DECODED_NS,
    UVC_PREVIEW_LAST_PUBLISHED_NS,
    UVC_PREVIEW_LAST_CONVERSION_NS,
    UVC_PREVIEW_PERFORMANCE_STAT_COUNT
};
