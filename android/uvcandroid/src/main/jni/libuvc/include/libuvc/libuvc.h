...
/** Debug counters for native UVC payload/frame-integrity decisions. */
enum uvc_integrity_stat_index {
    UVC_INTEGRITY_PACKETS_TOTAL = 0,
    UVC_INTEGRITY_PACKETS_ERR,
    UVC_INTEGRITY_FRAMES_COMPLETED_WITH_EOF,
    UVC_INTEGRITY_FRAMES_DROPPED_ERR,
    UVC_INTEGRITY_FRAMES_DROPPED_MISSING_EOF,
    UVC_INTEGRITY_FRAMES_DROPPED_FID_TRANSITION,
    UVC_INTEGRITY_FRAMES_DROPPED_SIZE_MISMATCH,
    UVC_INTEGRITY_RAW_YUY2_FRAMES_ACCEPTED,
    UVC_INTEGRITY_RAW_YUY2_FRAMES_DROPPED,
    UVC_INTEGRITY_STAT_COUNT
};
